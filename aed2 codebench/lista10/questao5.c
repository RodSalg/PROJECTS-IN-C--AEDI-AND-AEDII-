...
void inserir(Pessoa tabelaHash[], int mat, char nome[], int M)
{
    Pessoa pes;
    pes.matricula = mat;
    strcpy(pes.aluno, nome);
...
void imprimir(Pessoa tabelaHash[], int M)
{
    ...
    for (i = 0; i < M; i++)
    {
        ...
        {
            printf("%d %d %d\n", i, tabelaHash[i].matricula, gerarCodigoHash(tabelaHash[i].matricula, M));
        }
        else
        {
            printf("%d \\\n", i);
...
int main()
{
    ...
    for (int i = 0; i < n; i++)
    {
        ...
        scanf("%s", &nomedoido);
        // scanf("%c");
        inserir(tabelaHash, num, nomedoido, tam);
    }
    printf("\n");
    ...
    {
        scanf("%d", &rem);
        remover_hash(tabelaHash, rem, tam);
    }
    // printf("passei2\n");
